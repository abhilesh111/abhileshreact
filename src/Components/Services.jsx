...
const Services = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-24 lg:pt-16 custom-bg">
      ...
      <div className=" flex flex-col lg:flex-row gap-5 pt-14 service-box">
