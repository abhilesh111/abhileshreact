...
const About = () => {
  return (
    <div className=" min-h-screen custom-mid flex flex-col lg:flex-row justify-between items-center lg:px-32 px-5 gap-5">
      <div className=" w-full lg:w-3/4 space-y-4 font-light">
