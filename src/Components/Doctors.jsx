...
const Doctors = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16 custom-doctors">
      ...
      <div className=" mt-5">
        <Slider ref={slider} {...settings}>
          {data.map((e, index) => (
            <div
              className="h-[350px] text-black rounded-xl mb-2 cursor-pointer shedow-box"
              key={index}
            >
              <div>
                <img
              ...
              <div className=" flex flex-col justify-center items-center">
                <h1 className="font-light text-xl pt-4">{e.name}</h1>
                <h3 className="font-light pt-2">{e.specialties}</h3>
              </div>
            </div>
          ))}
        </Slider>
