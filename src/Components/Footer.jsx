...
const Footer = () => {
  return (
    <div className=" bg-backgroundColor text-white mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5 font-light">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">Mscript</h1>
          <p className=" text-sm">
      ...
      <div>
        ...
        Copyright © 2025r - All right reserved By
          <span className=" text-hoverColor p-2">Abhilesh khare</span>
        </p>
      </div>
    </div>
  );
